...
def Wordle5():
    global pos_x, pos_y, guess, green, words, alphabet
                    ...
                    if pos_x == 5:
                        if pos_y < 5:
                            ...
                            if check_word(guess2.lower(),words) == True:
                                ...
                                text_surface = my_font.render("WORD NOT IN LIST",False,(255,255,255))
                                screen.blit(text_surface,(100,480))
                                pygame.display.flip()
                                time.sleep(1)
                                pygame.draw.rect(screen,(0,0,0),pygame.Rect(0,490,710,60))
                        if pos_y > 4:
                            word = reset()
        pygame.display.flip()
    return False
